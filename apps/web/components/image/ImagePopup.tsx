...
export const ImagePopup = ({
  ...
  const handleDownload = async () => {
    if (!image?.cloudfrontUrl) return;

    try {
      setDownloading(true);

      const link = document.createElement("a");
      link.href = image.cloudfrontUrl;
      ...
      toast.error("Failed to download image", { position: "top-center" });
    } finally {
    ...
    <>
      ...
      >
        ...
        <div className="md:w-[55%] h-[35vh] md:h-full secondary-bg flex items-center justify-center p-6 relative overflow-hidden">
          <div
            className="group relative cursor-pointer w-full h-full flex items-center justify-center"
        ...
        <div className="md:w-[45%] h-[calc(65vh-2rem)] md:h-full p-6 flex flex-col overflow-y-auto">
          ...
          <div className="mt-auto">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button
                onClick={() =>
                  image && onDelete(image.contentId, image.extension)
                }
